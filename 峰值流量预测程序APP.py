...
# 界面布局
st.title("AI-based Dam Break Prediction System")

# 仅显示前4个重要特征的输入项
st.header("Feature selection yielded the four most influential parameters")
feature_values = {}
...
# 预测逻辑
if st.button("Predict peak discharge (Qp) "):
    try:
        ...
        st.success(f"**Peak discharge (Qp) :** {prediction:.2f}")
    except Exception as e:
